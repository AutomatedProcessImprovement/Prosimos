...
class LogInfo:
    ...
    def compute_execution_times(self, trace_info: Trace, process_kpi: KPIMap, is_fuzzy=False):
    ...
    def save_joint_statistics(self, bpm_env):
        ...
        self.compute_full_simulation_statistics(bpm_env.stat_fwriter, bpm_env.sim_setup.is_fuzzy)
    ...
    def compute_full_simulation_statistics(self, stat_fwriter, is_fuzzy=False):
        process_kpi = KPIMap()
        for trace_info in self.trace_list:
            self.compute_execution_times(trace_info, process_kpi, is_fuzzy)
