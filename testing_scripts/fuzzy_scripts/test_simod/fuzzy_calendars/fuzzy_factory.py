...
from testing_scripts.fuzzy_scripts.test_simod.discovery.distribution import get_best_distribution
from testing_scripts.fuzzy_scripts.test_simod.fuzzy_calendars.intervals_frequency_calculator import ProcInfo
    ...
    def compute_processing_times(self, fuzzy_calendars, min_obs=10, k=3):
        ...
        for r_id in adjusted_durations:
            ...
            for t_id in adjusted_durations[r_id]:
                # if r_id == 'Clerk-000008' and t_id == 'Prepare acceptance pack':
                #     print("hola")
                #     count += 1
        ...
        # for r_id in res_task_distribution:
        #     for t_id in res_task_distribution[r_id]:
        #         if res_task_distribution[r_id][t_id] is not None and res_task_distribution[r_id][t_id]["distribution_name"] == "default":
        #             print("hola")
        #
        #
