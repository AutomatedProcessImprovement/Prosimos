...
def run_diff_res_simulation(start_date, total_cases, bpmn_model, json_sim_params, is_fuzzy,
                            out_stats_csv_path, out_log_csv_path, fixed_arrival_times=None):
    s_t = datetime.datetime.now()
    run_simulation(bpmn_model, json_sim_params, total_cases, is_fuzzy, out_stats_csv_path, out_log_csv_path, start_date,
                   fixed_arrival_times)
