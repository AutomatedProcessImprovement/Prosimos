...
def run_diff_res_simulation(start_date, total_cases, bpmn_model, json_sim_params,
                            out_stats_csv_path, out_log_csv_path, fixed_arrival_times=None, process_state=None, simulation_horizon=None):
    s_t = datetime.datetime.now()
    run_simulation(bpmn_model, json_sim_params, total_cases, out_stats_csv_path, out_log_csv_path, start_date,
                   fixed_arrival_times=fixed_arrival_times, process_state=process_state, simulation_horizon=simulation_horizon)
