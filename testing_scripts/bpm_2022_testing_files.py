...
process_files = {
    'demo_example': {
        ...
        'bpmn': '/Users/iryna/Downloads/new-model.bpmn',
        # './../input_output_files/discovery_input_files/bpmn_models/Credit_Application_Simulation.bpmn',
        'json': '/Users/iryna/Downloads/App_final_trimEnds_allowedBehav_proper_sim_scenario.json',
        # './../input_output_files/discovery_output_files/json/demo_example.json',
